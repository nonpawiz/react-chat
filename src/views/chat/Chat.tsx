                    ...
                    <div className='col-md-9'>
                        <div className='card w-100'>
                            ...
                            <div className='d-flex justify-content-between align-items-center'>
                                <input id="textInputExample" type="text" className="form-control p-1 border-0 py-2" placeholder='พิมพ์' />
                                <div className='mx-1'>
                                    <button className='btn bg-btn-ok text-light border-0 p-1 px-2 w-100'><i className="uil uil-navigator"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
